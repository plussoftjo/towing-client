        ...
        if(this.state.modal_show == 'Select') {
            return (
                <View style={{ flex: 1,justifyContent:'center',alignItems:'center',alignContent:'center' }}>
                    <View style={{backgroundColor:'white',borderRadius:10,width:'100%',borderColor:'#27ae60',borderWidth:2,width:'98%'}}>
                        <View style={{padding:10,paddingLeft:10,borderBottomColor:'rgba(0,0,0,0.03)',borderBottomWidth:1,flexDirection:'row',alignItems:'center',justifyContent:'space-between',backgroundColor:'#27ae60',borderRadius:8}}>
                            <Text style={{fontWeight:'500',fontSize:18,color:'white'}}>Vehicle Informations</Text>
                            <Icon name="close-circle" style={{color:'white'}} onPress={() => {this.props.onPressSave()}} />
                        </View>
                        {this.props.auth.user.user_car.map((trg,index) => 
                            ...
                            <View style={{position:'absolute',right:'10%',top:'30%',zIndex:123}}>
                                <Icon name="ban" onPress={() => {
                                    this.props.auth.user.user_car.splice(index,1);
                                }} type="SimpleLineIcons" style={{color:'#e74c3c',fontSize:24}} />
                            </View>
                        </View>
                        )}
