...
export default class DropOff extends React.Component {
    ...
    async _search(value) {
        ...
        let coords = this.props.locations.pickup_coords;
    ...
    async _click_result(place) {
        ...
        let result = await googleapi.directions(place,this.props.locations.pickup_coords);
        let distance = await googleapi.distance_matrix(place,this.props.locations.pickup_coords);
        ...
        this.props.processor.service.dropoff_location = place;
        this.props.manger.mapLayout.target_directions = true;
        this.props.manger.mapLayout.direction_marker = true;
            ...
            <Animatable.View duration={500} animation="slideInUp" style={{backgroundColor:'white',height:'100%',width:'100%',position:'absolute',left:0,top:0,zIndex:102}}>
                ...
                <View style={{padding:20,paddingTop:5}}>
                    <Item regular style={styles.input_card}>
                        ...
                        <Input value={this.state.text} autoFocus onChangeText={(value) => {this._change_value(value);}} placeholder={'Select Place'} placeholderTextColor="black" style={{fontWeight:'700',fontFamily:'Roboto_medium'}} />
                    </Item>
                </View>
                ...
                <Content>
                    <List>
                        ...
                        {/* {this.state.PlacesList.length == 0 && 
                            <ListCard icon="pin" text={'Type to search'} press={() => {console.log('hh')}}></ListCard>
                        } */}
                    </List>
                </Content>
            </Animatable.View>
